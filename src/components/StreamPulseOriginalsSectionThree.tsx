...
export default function StreamPulseOriginalsSectionThree({
  movies,
  onSelectMovie,
    ...
    <section className="w-full px-4 sm:px-8 md:px-12 lg:px-16 py-5 sm:py-7">
      ...
      <div className="flex items-center justify-between mb-3.5 sm:mb-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="hidden sm:inline-flex items-center space-x-1 px-2 py-0.5 rounded-full bg-[#FF5500]/15 border border-[#FF5500]/30 text-[#FF5500] text-[10px] font-extrabold uppercase tracking-wider">
